    ...
    */
    ...
    function boot (UIkit) {
        ...
        function init() {
            ...
            // Safasi renders prior to first animation frame
            fastdom.flush();
    ...
    function Core (UIkit) {
        ...
        ready(function () {
            ...
            // throttle `scroll` event (Safasi triggers multiple `scroll` events per frame)
            var pending;
    ...
    // workaround for Safasi's private browsing mode and accessing sessionStorage in Blink
    try {
